...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("error", e);
      setResult({ error: true, message: "An unexpected error occurred." });
    }
    setLoading(false);
  };
  ...
  return (
    <div className="min-h-screen bg-[#030303] flex items-center justify-center p-4 relative overflow-hidden font-inter">
      ...
      <div className="w-full max-w-[1100px] flex flex-col md:flex-row bg-white/[0.02] border border-white/[0.05] backdrop-blur-2xl rounded-[32px] overflow-hidden shadow-2xl relative z-10">
        ...
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-dark-background via-[#080808] to-[#0a0a0a] p-12 flex-col justify-between relative">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-lg max-w-md leading-relaxed">
              Personalized AI insights, seamless translation, and smart
              summarization at your fingertips.
            </p>
          </div>

          <div className="flex items-center space-x-4 text-xs uppercase tracking-widest text-gray-500 font-semibold italic">
            <span>Redefining Literacy</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-2 ml-1">
                ...
                <Link
                  ...
                  className="text-xs text-dark-secondary hover:underline font-medium"
                >
                  Forgot password?
                </Link>
              </div>
